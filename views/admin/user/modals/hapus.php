<div id="modal-hapus" class="hidden fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div class="relative bg-white rounded-2xl w-full max-w-sm mx-4 shadow-2xl">
        <div class="p-8 text-center">
            ...
            <p class="text-sm text-body/70 mb-2">Anda yakin ingin menghapus user:</p>
            ...
            <form id="formHapus" action="/admin/user.php" method="POST" class="flex space-x-3">
                <input type="hidden" name="action" value="hapus">
                <input type="hidden" name="id" id="hapus-id">
                <input type="hidden" name="nama" id="hapus-nama-input">
