...
<div class="flex items-center text-sm text-body/70 mb-4">
    ...
    <span class="text-heading font-medium">Manajemen User</span>
</div>

<!-- Header -->
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
    <div>
        <h1 class="text-2xl font-bold text-heading">Manajemen User</h1>
        <p class="text-sm text-body/70 mt-1">Kelola data User</p>
    </div>
    ...
    <div class="bg-white rounded-xl border border-default p-5 hover:shadow-md transition-shadow">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-heading mt-1"><?= $totalUser ?></p>
            </div>
