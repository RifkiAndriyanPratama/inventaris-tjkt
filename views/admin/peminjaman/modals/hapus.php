<div id="hapus" class="hidden fixed inset-0 z-50 flex items-center justify-center">
    <div class="absolute inset-0 bg-black/50 backdrop-blur-sm" onclick="closeModal('hapus')"></div>
    <div class="relative bg-white rounded-2xl w-full max-w-sm mx-4 shadow-2xl">
        <div class="p-8 text-center">
            ...
            <p class="text-sm text-body/70 mb-2">Anda yakin ingin menghapus peminjaman:</p>
            ...
            <form id="formHapus" action="/admin/peminjaman.php" method="POST" class="flex space-x-3">
                <input type="hidden" name="action" value="hapus">
                <input type="hidden" name="id" id="hapus-id">
                <input type="hidden" name="nama_barang" id="hapus-nama-input">
                <button type="button" onclick="closeModal('hapus')"
